...
DEFAULT_USER_API_BASE = (
    f"http://{DEFAULT_USER_API_HOST}:{DEFAULT_USER_API_PORT}/api/core"
)
DEFAULT_ROOT_ENDPOINT = f"{DEFAULT_USER_API_BASE}/v1/"

DEFAULT_MCP_API_HOST = "127.0.0.1"
DEFAULT_MCP_API_PORT = 11014
