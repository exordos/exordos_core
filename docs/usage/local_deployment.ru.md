...
где `<version>` — версия платформы для развёртывания (например, `0.2.14`). Доступные версии можно посмотреть на [странице релизов](https://github.com/exordos/exordos_core/releases).
