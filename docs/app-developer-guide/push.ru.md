...
Вы можете отправлять элементы в [публичный репозиторий Exordos Core](../usage/public-installation.md). Или вы можете развернуть [приватную установку Exordos Core](../usage/private-installation.md) на своём оборудовании. Для разработки и тестирования вы можете использовать [установку на локальном ноутбуке](../usage/local-laptop-installation.md).
...
- [`exordos deploy`](deploy.md) — развёртывание элемента в установку Exordos
...
Если вы столкнулись с проблемами при отправке элементов — такими как ошибки подключения к репозиторию, ошибки аутентификации или проблемы загрузки — обратитесь к [Руководству по устранению неполадок](../usage/troubleshooting.md) для подробных решений и типичных исправлений.
