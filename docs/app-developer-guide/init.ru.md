...
[Подробнее о мастере →](../usage/wizard.md)
...
Если вы столкнулись с проблемами во время инициализации — такими как ошибки определения типа проекта, ошибки генерации манифеста или проблемы конфигурации CI/CD — обратитесь к [Руководству по устранению неполадок](../usage/troubleshooting.md) для подробных решений и типичных исправлений.
